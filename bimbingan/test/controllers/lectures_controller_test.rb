...
class LecturesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create lecture" do
    assert_difference('Lecture.count') do
      post lectures_url, params: { lecture: { alamat: @lecture.alamat, id_dos: @lecture.id_dos, nama: @lecture.nama } }
    end
  ...
  test "should update lecture" do
    patch lecture_url(@lecture), params: { lecture: { alamat: @lecture.alamat, id_dos: @lecture.id_dos, nama: @lecture.nama } }
