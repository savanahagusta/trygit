...
class MajorsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create major" do
    assert_difference('Major.count') do
      post majors_url, params: { major: { id_jur: @major.id_jur, jurusan: @major.jurusan, prodi: @major.prodi } }
    end
  ...
  test "should update major" do
    patch major_url(@major), params: { major: { id_jur: @major.id_jur, jurusan: @major.jurusan, prodi: @major.prodi } }
